...
ActiveRecord::Schema.define(version: 2020_04_04_173717) do
  ...
  create_table "quantites", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.string "unite_mesure"
    t.integer "dose"
    t.index ["ingredient_id"], name: "index_quantites_on_ingredient_id"
    t.index ["recette_id"], name: "index_quantites_on_recette_id"
  end
  ...
  create_table "recettes", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.integer "temps_preparation"
    t.integer "temps_cuisson"
  ...
  add_foreign_key "quantites", "recettes"
end
